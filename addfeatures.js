...
// opens the tinyMCE toolbar rows 2 and 3 on load (once a user collapses this again, it stops working)
	...
	if (assessmentSectionName.match(/Key Contacts/) != null && window.location.href.slice(-10) == "&section=18"){
		//check if it is School of Science
		if (SchoolSpecific.match(/School of Science|Education Excellence/) != null && window.location.href.slice(-10) == "&section=18"){
